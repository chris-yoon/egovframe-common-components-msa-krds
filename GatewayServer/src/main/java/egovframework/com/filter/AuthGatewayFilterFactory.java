...
public class AuthGatewayFilterFactory extends AbstractGatewayFilterFactory<AuthGatewayFilterFactory.Config> {
    ...
    public AuthGatewayFilterFactory(WebClient.Builder webClientBuilder, GatewayJwtProvider gatewayJwtProvider, ReactiveCircuitBreakerFactory circuitBreakerFactory) {
        super(Config.class);
    ...
    private Mono<Void> regenerateAccessToken(ServerWebExchange exchange, String refreshToken, GatewayFilterChain chain) {
        ReactiveCircuitBreaker circuitBreaker = circuitBreakerFactory.create("loginCircuitBreaker");
